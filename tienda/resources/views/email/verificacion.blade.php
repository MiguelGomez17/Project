                    ...
                    <tr>
                        <td class="header"
                            ...
                            <a href="http://localhost"
                                ...
                                <img src="{{asset('images/Logo.jpg')}}" style="width: 25%; max-height: auto;">
                            </a>
                        </td>
                    </tr>
                    <!-- Email Body -->
                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <p
                                            ...
                                            Por favor usa el siguiente codigo para verificar tu correo.</p>
                                        ...
                                        <p
                                            style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            Si no fuiste tu quien creo un usuario en nuestro sitio, ignora este mensaje.
                                        </p>
                                        <p
                                            style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            Saludos,<br>Dicesa</p>
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    <p
                                                        ...
                                                        Si tiene problemas para verificar su correo contacte con nosotros.
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
