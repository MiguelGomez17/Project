                ...
                <div class="panel-body">
                    <div class="container" style="width: 100%">
                        <div class="alert alert-danger" id="warning" role="alert">
                            El importar un archivo de productos <a href="#" class="alert-link">eliminara todos los productos</a> de la base de datos actual y los reemplazara por los que contenga el archivo.
                        </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="container" style="width: 100%;">
                                            ...
                                            <h4>En un archivo de Excel haga una lista con las claves, descripciones, existencias, linea y precios de TODOS los productos como se muestra en la siguiente imagen.</h4>
                                            <h4>Las existencias, linea y precios no seran visibles en la pagina pero permitiran la organizacion de productos.</h4>
                                            <img class="card-img-top" src="{{asset('images/Gn2RM01hdT10CbhasDL/(1).png')}}" style="width: 95%;" alt="Card image cap">
                                        </div>
                                        <div class="container" style="width: 100%;">
                                        ...
                                        <div class="container" style="width: 100%;">
                                            <h3>Nota</h3>
                                            <h4>Se recomienda subir un archivo de categorias antes de subir uno de productos para que estos se guarden en la categoria correspondiente.</h4>
                                        </div>
                                    </div>
