...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        */
        ...
        $productsVendidos = DB::table('products')->where('inventory','>',0)->orderBy('inventory','asc')->paginate(3, ['*'], 'Vendidos');
        $productsNuevo = DB::table('products')->where('inventory','>',0)->orderBy('description', 'asc')->paginate(3, ['*'], 'Nuevos');
